  ...
  const startGame = async (e) => {
    ...
    try {
      ...
      const modeSelectCard = {
        ...
        image_url: 'https://images.unsplash.com/photo-1555861496-faa66bfcb9d8?auto=format&fit=crop&q=80&w=600&h=600',
      ...
      const introCard = {
        ...
        card_type: 'resolution',
        image_url: groupInfo.intro_image_url || groupInfo.bg_image_url || 'https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?auto=format&fit=crop&q=80&w=600&h=600',
